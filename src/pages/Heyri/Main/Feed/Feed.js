      ...
      <div className="divFeeds">
        ...
        <div className="MainStatus">
          <div className="status">
            <div className="status1">
              ...
              <img
                ...
                alt="comment"
              />
              <svg width="22" height="22" viewBox="0 0 48 48" className="paper">
          ...
          <div className="textId">
            ...
            <span className="text2">안녕하세요 여러분 모두 반가워요 😃</span>
          </div>
        ...
        <div className="button1">
          <input className="button2" type="text" placeholder="댓글 달기..." />
